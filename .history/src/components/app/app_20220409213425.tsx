...
function App({placesCount, offerData}:AppScreenProps): JSX.Element {
  const [firstOffer] = offerData;
  return (
    <BrowserRouter>
      <Routes>
        ...
        />
        <Route path={AppRoute.Room} element={<Property firstOffer={firstOffer as SingleOffer}></Property>}>
        </Route>
